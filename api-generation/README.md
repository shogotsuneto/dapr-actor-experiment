...
This directory contains tools and configurations for schema-first development.
...
- ✅ **External Docker Generator**: Uses `ghcr.io/shogotsuneto/dapr-actor-gen:v0.0.2` for OpenAPI code generation with embedded templates
...
This installs the external Docker-based generator `ghcr.io/shogotsuneto/dapr-actor-gen:v0.0.2`.
