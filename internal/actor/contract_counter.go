...
// ContractCounterActor demonstrates API-contract-first development
type ContractCounterActor struct {
	actor.ServerImplBaseCtx
}

func (c *ContractCounterActor) Type() string {
	return "CounterActor"
}

func (c *ContractCounterActor) Increment(ctx context.Context) (*generated.CounterState, error) {
...
func (c *ContractCounterActor) Decrement(ctx context.Context) (*generated.CounterState, error) {
	state, err := c.getState(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *ContractCounterActor) Get(ctx context.Context) (*generated.CounterState, error) {
	state, err := c.getState(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *ContractCounterActor) Set(ctx context.Context, request generated.SetValueRequest) (*generated.CounterState, error) {
...
func (c *ContractCounterActor) getState(ctx context.Context) (*generated.CounterState, error) {
	stateKey := "counter"
...
func (c *ContractCounterActor) setState(ctx context.Context, state *generated.CounterState) error {
	stateKey := "counter"
	return c.GetStateManager().Set(ctx, stateKey, state)
}

func (c *ContractCounterActor) validateSetRequest(request generated.SetValueRequest) error {
	const (
		minInt32 = -2147483648
		maxInt32 = 2147483647
	)
...
func ValidateContract() error {
	...
	var actor ContractCounterActor
