...
echo "  2. Test the application: ./scripts/quick-demo.sh"
echo "  3. Run full integration tests: make test-integration-kind"
echo "  4. Cleanup when done: ./scripts/kind-cleanup.sh"
echo ""
echo "Cluster info:"
